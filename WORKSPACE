...
new_http_archive(
  ...
  urls = ["https://github.com/jemdiggity/nrf5_sdk/archive/v14.0.0.tar.gz"],
  sha256 = "fa490fdb33ce52bf0b7fe7de97e7ed9a4be6d999d9bd98a68c7c006c23e1f077",
  strip_prefix = "nrf5_sdk-14.0.0/sdk",
)
